 ...
 */
#ifndef FEA_SURF_HEADER
#define FEA_SURF_HEADER
...
public:
    ...
    void set_image (dpgrid::ByteImage::ConstPtr image);
...
protected:
    ...
    struct Octave
    {
        ...
        typedef dpgrid::Image<RespType> RespImage; ///< Hessian response map type
...
protected:
    ...
    typedef dpgrid::Image<SatType> SatImage; ///< SAT image type
